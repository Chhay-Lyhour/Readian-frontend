...
const RevenueGrowthChart = () => {
  ...
  const hasRevenueByPlan = data && data.summary && data.summary.revenueByPlan && data.summary.revenueByPlan.length > 0;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-[#FFFDEE] rounded-lg p-4 border-2 border-[#00A819]">
            ...
            {hasRevenueByPlan ? (
              ...
              <p className="text-sm text-gray-500 mt-2">No revenue data</p>
            )}
          </div>
        </div>
      )}
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        {!hasData ? (
          <div className="flex flex-col items-center justify-center h-96 text-gray-500">
            <DollarSign size={64} className="mb-4 text-gray-300" />
            <p className="text-lg font-semibold">No revenue data for this period</p>
